...
class CDetallePedido @Inject()(@NamedDatabase("sicap")
													 protected val dbConfigProvider: DatabaseConfigProvider)
	extends HasDatabaseConfigProvider[JdbcProfile] {

	import profile.api._

	private val qryDetPedido = TableQuery[tblDetallePedido]

	private class tblDetallePedido(tag: Tag) extends Table[DetallePedido](tag, "qry_detallepedido") {
