...
class CRptSolicitudPago2 @Inject()( @NamedDatabase("sicap") protected val dbConfigProvider: DatabaseConfigProvider )
extends HasDatabaseConfigProvider[JdbcProfile] {
	...
	//private class tabla(tag: Tag) extends Table[ String :: String :: Int :: Fechas :: String :: Fechas :: String :: Fechas :: String :: Int :: Int :: String :: String :: String :: String :: String :: String :: String :: String :: Double :: Double :: Double :: HNil ](tag, Some("zickaprpts"), "qry_reporte_solicitudes_pago") {
	private class tabla(tag: Tag) extends Table[RptSolicitudPago2](tag, Some("zickaprpts"), "qry_reporte_solicitudes_pago") {
		...
		def * = (id_comparativo :: folio :: ejercicio :: fecha :: alta_almacen :: fecha_alta :: no_pedido :: fecha_pedido :: elaboro :: ejercicio_pedido :: ejercicio_presupuesto :: tipo_compra :: requerimiento :: oficina ::	destino :: cve_provedor :: razon_social ::	programa :: partida :: subtotal :: iva :: total :: HNil).mappedWith(Generic[RptSolicitudPago2])
	}

	def getAll: Future[(Seq[RptSolicitudPago2], String)] = db.run(query.result.map((p => (p, "found"))))

	def getBetweenDate(dateStart: String, dateEnd: String): Future[(Seq[RptSolicitudPago2], String)] = {
	...
	def ById(folio: String, ejercicio: Int): Future[(RptSolicitudPago2, String)] =
